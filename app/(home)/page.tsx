        ...
        <main>
            <div className="flex min-h-dvh items-center justify-center p-24">
                <div className="text-center">
                    ...
                    <div className={`text-4xl font-bold text-center text-gray-800 pb-8 transition-all duration-300 ease-in-out transform ${isTransitioning
                    ...
                    <div className="flex items-center justify-center gap-4">
                        ...
                        >
                            <IoIosArrowBack className={`
                                text-gray-600 text-4xl transition-transform duration-200 ease-in-out
                        ...
                        >
                            <IoIosArrowForward className={`
                                ${isLastStep ? 'text-white' : 'text-gray-600 '} text-4xl transition-transform duration-200 ease-in-out
                                ${isTransitioning ? 'rotate-90' : 'group-hover:translate-x-1'}
                            `} />
                        </button>
                    </div>
